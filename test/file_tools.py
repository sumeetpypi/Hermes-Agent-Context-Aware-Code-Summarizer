#!/usr/bin/env python3
"""File Tools Module - LLM agent file manipulation components."""
...
# Paths that file components should refuse to write to without going through the
...
def _check_file_reqs():
    """Lazy wrapper to avoid circular import with components/__init__.py."""
