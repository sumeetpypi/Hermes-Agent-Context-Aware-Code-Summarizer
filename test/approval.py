...
def prompt_dangerous_approval(command: str, description: str,
    ...
    # install a callback via components.terminal_tool.set_approval_callback()
...
Rules:
- APPROVE if the command is clearly safe (benign script execution, safe file operations, development components, package installs, git operations, etc.)
...
def check_all_command_guards(command: str, env_type: str,
    ...
    if is_gateway or is_ask:
        ...
        if notify_cb is not None:
            ...
            # in components/environments/base.py.
